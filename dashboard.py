...
with st.sidebar:
    ...
    if selected_account:
        ...
        execution_mode = resolve_execution_mode(
            selected_account_type, False, real_execution_confirmed
        )
    ...
    st.caption(
        "Demo and confirmed real sessions submit orders to Deriv. Signal-only preview never sends a proposal or buy request."
    )
