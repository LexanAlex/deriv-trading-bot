...
with st.sidebar:
    ...
    if oauth_token:
        ...
        # link_button opens a new tab; OAuth must replace this tab so the
        # callback URL returns to the active Streamlit browser session.
        st.markdown(
            f'<a href="{oauth_login_url}" target="_self" '
