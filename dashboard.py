...
def start_bot(api_token: str, app_id: str, account_id: str, account_currency: str,
              ...
              barrier_sell: str, paper_trading: bool, strategy_sensitivity: str):
...
with st.sidebar:
    ...
    trading_mode = st.radio(
        ...
        index=0,
        help="Practice records signals using live ticks but never sends a buy request. Live mode can place real trades.",
    )
    paper_trading = trading_mode == "Practice"
    live_confirmation = ""
