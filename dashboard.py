...
with st.sidebar:
    ...
    if oauth_token:
        ...
        # Use Streamlit's native external-link control. It is not rendered in
        # a component frame, so it remains clickable under Streamlit Cloud's
        # browser restrictions. Complete the Deriv login in the opened tab;
        # Deriv redirects that tab back to this dashboard URL.
        st.link_button(
            "Login with Deriv",
            oauth_login_url,
            type="primary",
        ...
        st.caption("Complete login in the opened Deriv tab. Deriv must have this exact Streamlit URL registered as its OAuth Redirect URL.")
