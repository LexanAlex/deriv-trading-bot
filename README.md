...
15m / 30m alignment, one pullback, and two continuation ticks. The default
recovery settings are 1.5× for up to two steps. These are execution rules, not
a promise of profit; validate them on a demo account before enabling Live.
