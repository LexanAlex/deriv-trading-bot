...
# ---------------------------------------------------------------------------
# Register this value in Deriv's dashboard and set its OAuth Redirect URL to
# the exact public URL of this Streamlit app. The public demo app ID (1089)
# cannot redirect users back to an application you control.
...
DERIV_APP_ID = os.getenv("DERIV_APP_ID") or _streamlit_secret("DERIV_APP_ID") or "1089"
