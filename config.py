"""
config.py
Central configuration for the Deriv Volatility 10 (1s) Trading Bot.
"""
...
# Compatibility only. The PAT client obtains an account-specific OTP WebSocket
# URL at runtime.
DERIV_WS_URL = ""
...
# ---------------------------------------------------------------------------
#
# MARTINGALE STEP SEMANTICS:
# DEFAULT_MAX_MARTINGALE_STEPS is the TOTAL number of stake levels, including
# the initial/base stake.
#
# Example with multiplier 2.5 and max steps 3:
#   step 0: 1.00
#   step 1: 2.50
#   step 2: 6.25
#   next loss resets to 1.00
#
# Total possible exposure before reset: 1 + 2.5 + 6.25 = 9.75x base.
#
# No maximum/minimum drawdown limits are added by design. Further risk limits
# are intentionally left to the operator.
