...
class DerivAPIClient:
    ...
    # A 5-tick contract expires in ~5 seconds. If Deriv takes >1s to answer a
    # proposal/buy request, the entry price is stale and the trade execution
    # is already too late. We fail fast so the engine can decide whether to
    # retry or abort the signal.
    REQUEST_TIMEOUT = 1.0
    
    # Pings are the fastest way to detect a dead connection. A 3s interval
