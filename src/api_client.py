...
class DerivAPIClient:
    ...
    def __init__(self, api_token: str, app_id: str = "1089"):
        ...
        self._authorized_account: Dict[str, Any] = {}
    ...
    async def authorize(self, oauth_token: Optional[str] = None) -> bool:
        ...
        try:
            ...
            if "authorize" in response:
                ...
                self._authorized_account = dict(account)
                logger.info(
    ...
    @property
    def authorized_account(self) -> Dict[str, Any]:
        """Account data returned by Deriv's successful authorize request."""
        return dict(self._authorized_account)
