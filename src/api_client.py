...
class DerivAPIClient:
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._ws = await websockets.connect(await self._websocket_url(), ping_interval=None, open_timeout=20, close_timeout=10)
    ...
    async def disconnect(self) -> None:
        ...
        for future in self._pending_requests.values():
            if not future.done():
                future.set_exception(DerivAPIError("Deriv connection closed.", "CONNECTION_CLOSED"))
