...
class StrategyEngine:
    """Tick momentum strategy with immediate and pullback entry modes."""
    ...
    def __init__(
        ...
        self._reject_event_pending: Optional[str] = None
    ...
    def consume_reject_event(self) -> Optional[str]:
        reason = self._reject_event_pending
        self._reject_event_pending = None
        return reason
    ...
    def get_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "reject_cooldown_ticks": self._reject_cooldown_ticks,
        }
    ...
    def _reject_signal(
        ...
        self._reject_event_pending = reason
    ...
    def _passes_entry_filters(
        ...
        if entry_mode == "pullback":
            ...
            if retrace < limits["min_pullback_retrace"]:
                return (
                    False,
                    f"pullback too shallow {retrace:.2f} below {limits['min_pullback_retrace']:.2f}",
                )

            if retrace > limits["max_pullback_retrace"]:
                return (
                    False,
                    f"pullback too deep {retrace:.2f} above {limits['max_pullback_retrace']:.2f}",
                )
